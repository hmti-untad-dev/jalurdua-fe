export default function VisiMisi() {
  return (
    <div>
      ...
      <div className="mx-16 flex flex-wrap justify-center gap-10 gap-y-32 py-16 lg:flex-nowrap">
        <div className="group color h-[230px] w-80 cursor-pointer rounded-2xl border-[1px] border-black bg-gray-200 p-4 transition-all hover:bg-[#3E3F90] lg:h-[335px] lg:p-5">
          <div>
            <img
              src="../../public/images/pendidikan.png"
              alt="pendidikan"
              className="mx-auto -mt-28 h-40 transition-all group-hover:-translate-y-4 group-hover:scale-105 group-hover:rotate-2 lg:h-52"
            />
          </div>
          <div className="text">
        ...
        <div className="group color h-[230px] w-80 cursor-pointer rounded-2xl border-[1px] border-black bg-gray-200 p-4 transition-all hover:bg-[#3E3F90] lg:h-[335px] lg:p-5">
          <div>
            <img
              src="../../public/images/penelitian.png"
              alt="penelitian"
              className="mx-auto -mt-28 h-40 transition-all group-hover:-translate-y-4 group-hover:scale-105 group-hover:-rotate-2 lg:h-52"
            />
          </div>
        ...
        <div className="group color h-[230px] w-80 cursor-pointer rounded-2xl border-[1px] border-black bg-gray-200 p-4 transition-all hover:bg-[#3E3F90] lg:h-[335px] lg:p-5">
          <div>
            <img
              src="../../public/images/pengabdian.png"
              alt="pengabdian"
              className="mx-auto -mt-28 h-40 transition-all group-hover:-translate-y-4 group-hover:scale-105 group-hover:rotate-2 lg:h-52"
            />
          </div>
        ...
        <div className="group color h-[230px] w-80 cursor-pointer rounded-2xl border-[1px] border-black bg-gray-200 p-4 transition-all hover:bg-[#3E3F90] lg:h-[335px] lg:p-5">
          <div>
            <img
              src="../../public/images/kemitraan.png"
              alt="kemitraan"
              className="mx-auto -mt-28 h-40 transition-all group-hover:-translate-y-4 group-hover:scale-105 group-hover:-rotate-2 lg:h-52"
            />
          </div>
